    ...
    switch( getPhy->Attribute )
    {
        ...
        case PHY_NEXT_LOWER_TX_DR:
        {
            RegionCommonGetNextLowerTxDrParams_t nextLowerTxDrParams =
            {
                ...
                .MaxDr = ( int8_t )MA869_TX_MAX_DATARATE,
                .MinDr = ( int8_t )MA869_TX_MIN_DATARATE,
                .NbChannels = MA869_MAX_NB_CHANNELS,
...
bool RegionMA869AdrNext( AdrNextParams_t* adrNext, int8_t* drOut, int8_t* txPowOut, uint8_t* nbTransOut, uint32_t* adrAckCounter )
{
    ...
    *adrAckCounter = adrNext->AdrAckCounter;
    ...
    if( adrNext->AdrEnabled == true )
    {
      ...
      if( adrNext->AdrAckCounter >= ( MA869_ADR_ACK_LIMIT + MA869_ADR_ACK_DELAY ) )
      {
       ...
       if( adrNext->AdrAckCounter >= ( uint32_t )( MA869_ADR_ACK_LIMIT + ( MA869_ADR_ACK_DELAY << 1 ) ) )
       {
        if( ( ( adrNext->AdrAckCounter - MA869_ADR_ACK_LIMIT ) % MA869_ADR_ACK_DELAY ) == 0 )
        {
