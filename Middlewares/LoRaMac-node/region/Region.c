...
#define AS923_ADR_NEXT( )                          AS923_CASE { return RegionAS923AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define AU915_ADR_NEXT( )                          AU915_CASE { return RegionAU915AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define CN470_ADR_NEXT( )                          CN470_CASE { return RegionCN470AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define CN779_ADR_NEXT( )                          CN779_CASE { return RegionCN779AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define EU433_ADR_NEXT( )                          EU433_CASE { return RegionEU433AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define EU868_ADR_NEXT( )                          EU868_CASE { return RegionEU868AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define KR920_ADR_NEXT( )                          KR920_CASE { return RegionKR920AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define IN865_ADR_NEXT( )                          IN865_CASE { return RegionIN865AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define US915_ADR_NEXT( )                          US915_CASE { return RegionUS915AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define RU864_ADR_NEXT( )                          RU864_CASE { return RegionRU864AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
#define KZ865_ADR_NEXT( )                          KZ865_CASE { return RegionKZ865AdrNext( adrNext, drOut, txPowOut, nbTransOut, adrAckCounter ); }
...
bool RegionAdrNext( LoRaMacRegion_t region, AdrNextParams_t* adrNext, int8_t* drOut, int8_t* txPowOut,  uint8_t* nbTransOut, uint32_t* adrAckCounter )
{
    switch( region )
    {
        AS923_ADR_NEXT( );
