...
/**
  ...
  */
#define RADIO_TX_LED_PIN                           GPIO_PIN_13

/**
  * @brief Port of Probe Line 2
  */
#define RADIO_TX_LED_PORT                          GPIOB

/**
  * @brief Enable GPIOs clock of Probe Line 2
  */
#define RADIO_TX_LED_CLK_ENABLE()                  __HAL_RCC_GPIOB_CLK_ENABLE()

/**
  * @brief Disable GPIOs clock of Probe Line 2
  */
#define RADIO_TX_LED_CLK_DISABLE()                 __HAL_RCC_GPIOB_CLK_DISABLE()
