...
#error "DEBUGGER_ENABLED not defined or out of range <0,1>"
  ...
  RADIO_TX_LED_CLK_ENABLE();

  GPIO_InitStruct.Pin    = RADIO_TX_LED_PIN;
  HAL_GPIO_Init(RADIO_TX_LED_PORT, &GPIO_InitStruct);

  /* Reset probe Pins */
  HAL_GPIO_WritePin(RADIO_TX_LED_PORT, RADIO_TX_LED_PIN, GPIO_PIN_RESET);
